...
const Hero = () => {
  ...
  return (
    <section
      className="relative min-h-screen pt-24 md:pt-32 pb-20 bg-no-repeat bg-cover bg-bottom"
      style={{ backgroundImage: `url('/bg_image.svg')` }}
    >
      {/* Background */}
      {/* <img
        src={bgImage}
      ...
      <div className="mx-auto px-6 container flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-120px)]">
        ...
        <div className="flex-1 relative mx-auto md:px-0 text-center lg:text-left md:mb-0 mb-12">
          <div className="max-w-2xl text-text-primary flex flex-col items-center lg:items-start">
            ...
            <p className="text-lg opacity-90 mb-8 leading-relaxed max-w-md text-text-primary/80 mx-auto lg:mx-0">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 flex-wrap">
              ...
              <Tooltip text="We'll be here soon!" position="bottom">
                <div className="inline-flex items-center gap-3 px-6 py-3.5 rounded-2xl bg-primary text-white font-semibold hover:bg-secondary transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 active:scale-95 shadow-md cursor-pointer">
                  <svg
              ...
              {/* Android Button */}
              <Link
                to="https://play.google.com/store/apps/details?id=com.rish.thenotepad"
                target="blank"
        ...
        <div className="relative flex-1 flex items-center justify-center z-20 lg:mt-0">
          ...
          >
            <div className="backdrop-blur-xl bg-white/20 border border-white/30 rounded-xl p-2 sm:p-3 shadow-2xl shadow-black/15 flex flex-col gap-1 sm:gap-1.5 w-28 sm:w-44 scale-90 sm:scale-100">
              ...
              {noteItems.map(({ Icon, label, accent }) => (
                <div
                  key={label}
                  className={`flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-[7px] sm:text-xs font-medium cursor-default transition-colors ${
                    accent
                ...
                >
                  <Icon
                    size={11}
                    strokeWidth={2}
                    className={`shrink-0 ${accent ? "text-white" : "text-purple-700"}`}
                  />
                  {label}
                </div>
              ))}
          ...
          {/* Card 2: Appearance */}
          <div
            className="pointer-events-auto absolute top-[8%] left-[73%] lg:top-[14%] lg:left-[70%]"
            style={{
          ...
          >
            <div className="backdrop-blur-xl bg-white/20 border border-white/30 rounded-xl p-2 sm:p-3 shadow-2xl shadow-black/15 flex flex-col gap-2 sm:gap-2.5 w-28 sm:w-40 scale-85 sm:scale-100">
              ...
              <div className="flex rounded-lg overflow-hidden border border-black/10 cursor-pointer">
                <div
                  className={`flex-1 flex flex-col items-center gap-1 py-2 bg-white/80 text-gray-800 text-[9px] sm:text-[11px] font-semibold`}
                ...
                <div
                  className={`flex-1 flex flex-col items-center gap-1 py-2 bg-gray-900/80 text-white text-[9px] sm:text-[11px] font-semibold`}
              ...
              <div className="flex items-center justify-between px-0.5">
                <span className="text-[9px] sm:text-[11px] text-text-primary/60">
                  Auto-switch
                </span>
          ...
          {/*Card 3: Sync Status */}
          <div
            className="pointer-events-auto absolute bottom-[10%] left-[73%] lg:bottom-[20%] lg:left-[70%] lg:right-auto"
            style={{
              animation: "floatA 7s ease-in-out infinite",
              animationDelay: "1.2s",
            }}
          >
            <div className="backdrop-blur-xl bg-white/20 border border-white/30 rounded-xl p-2 sm:p-3 shadow-2xl shadow-black/15 flex flex-col gap-1.5 sm:gap-2 w-28 sm:w-44 scale-85 sm:scale-100">
              <p className="text-[8px] sm:text-[10px] font-bold uppercase tracking-widest text-purple-700 mb-0.5">
                Sync Status
              </p>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[7px] sm:text-xs font-semibold text-text-primary">
                  All devices synced
                </span>
              </div>
              <p className="text-[7px] sm:text-[10px] text-text-primary/50 pl-4 -mt-0.5">
                Just now · 3 devices
              </p>
                ...
                {deviceItems.map(({ Icon, label }) => (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      />
                      <span className="text-[7px] sm:text-[11px] text-text-primary/70">
                        {label}
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
                      ...
                      />
                      <span className="text-[6px] sm:text-[9px] text-green-600 font-semibold">
                        Synced
                      </span>
                    </div>
                  </div>
